...
502 bad gateway: https://github.com/aws-samples/image-optimization/issues/22

```
aws configure
# access key => AKIAXFQ6KVSSW5IWOQUY
# region => ap-southeast-1
cdk bootstrap # (optional)
pnpm i
pnpm run build
cdk deploy -c S3_IMAGE_BUCKET_NAME=sea-life-images
```
